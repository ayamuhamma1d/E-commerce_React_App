...
import client1 from "./assets/img/Frame 874.png";
import client2 from "./assets/img/Frame 875.png";
import client3 from "./assets/img/Frame 876.png";
      ...
      <nav className="flex" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          <li className="inline-flex items-center">
            <a href="#" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#db4444] dark:text-gray-400 dark:hover:text-white">
          ...
          <li>
            <div className="flex items-center">
              <RiArrowRightSLine />
              <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-[#db4444] md:ms-2 dark:text-gray-400 dark:hover:text-white"> About</a>
            </div>
          </li>
      ...
      <section className="aboutContent py-10">
        <div className="grid items-center gap-12 lg:grid-cols-2 ">
          <div className="mt-12 lg:mt-0">
            ...
            <p className=" text-[hsl(0,2%,35%)] mb-3">Exclusive has more than 1 Million products to offer, growing at a very fast. Exclusive offers a diverse assotment in categories ranging  from consumer.</p>
          </div>
      ...
      <section className="card py-10">
        <div className="grid  gap-16 lg:grid-cols-4 items-center text-center ">
          <div className="border mt-12 lg:mt-0 py-5 hover:bg-[#db4444] hover:text-[#fff]">
            ...
            <h2 className=" text-3xl mb-2 font-bold tracking-tight  md:text-2xl xl:text-3xl">10.5k </h2>
          ...
          <div className="bg-[#db4444]  mt-12 lg:mt-0 py-5">
            ...
            <h2 className=" text-3xl mb-3 font-bold tracking-tight text-white md:text-3xl xl:text-3xl">33k </h2>

            <p className="text-white text-center  ">Mopnthly Produduct Sale</p>
          ...
          <div className="border mt-12 lg:mt-0 py-5 hover:bg-[#db4444] hover:text-[#fff]">
            ...
            <h2 className=" text-3xl mb-3 font-bold tracking-tight   md:text-3xl xl:text-3xl">45.5k </h2>
          ...
          <div className="border mt-12 lg:mt-0 py-5 hover:bg-[#db4444] hover:text-[#fff]">
            ...
            <h2 className=" text-3xl mb-3 font-bold tracking-tight  md:text-3xl xl:text-3xl">25k </h2>
      ...
      <section className="card py-10">
        <div className="grid   lg:grid-cols-3 align-middle justify-center ">
          <div className=" mt-12 lg:mt-0 py-8">
            ...
            <h2 className=" text-3xl mb-2 font-bold tracking-tight text-black md:text-3xl xl:text-3xl">Tom Cruise </h2>
          ...
          <div className=" mt-12 lg:mt-0 py-8">
            ...
            <h2 className=" text-3xl mb-2 font-bold tracking-tight text-black md:text-3xl xl:text-3xl">Emma Watson </h2>
          ...
          <div className=" mt-12 lg:mt-0 py-8">
            ...
            <h2 className=" text-3xl mb-2 font-bold tracking-tight text-black md:text-3xl xl:text-3xl">Will Smith</h2>
